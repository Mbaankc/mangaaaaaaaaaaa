...
async def play_commnd(
    ...
    if not await is_served_user(message.from_user.id):
        await message.reply_text(
            text="😢 عزيزي انت غير موثق في بيانات مانجا .\n☔ من فضلك استخدم /verify لتوثيق نفسك في بيانات مانجا.",
    ...
    plist_type = None
    spotify = None
    user_id = message.from_user.id if message.from_user else "5996341004"
